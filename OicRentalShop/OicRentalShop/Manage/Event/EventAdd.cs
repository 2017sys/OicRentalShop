...
namespace OicRentalShop.Manage.Event
{
    public partial class EventAdd : UserControl
    {
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(sd);
            CmdFunc("INSERT INTO TBL_EVENT(EVENT_NAME,EVENT_PRICE,TYPE_ID,EVENT_NUM,EVENT_START,EVENT_END,EVENT_OLD,EVENT_DELETE)  VALUES('"+txt_EventName.Text+"',"+txt_EventPrice.Text+","+txt_ItemType.Text+","+txt_ItemNum.Text+",#"+sd+"#,#"+ed+"#,1,false)");
        }
